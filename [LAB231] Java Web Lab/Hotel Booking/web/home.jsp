    ...
    <body>
        ...
        <div class="album py-5 bg-light">
            <div class="container">
                ...
                <c:if test="${sessionScope.SEARCH_FAIL != null}">
                    <div class="alert alert-danger" role="alert">              
                        ${sessionScope.SEARCH_FAIL}  
                    </div>
                </c:if>
                <c:remove var="SEARCH_FAIL" scope="session"></c:remove>
                ...
                <c:remove var="FEEDBACK_SUCCESS" scope="session"></c:remove>
                    <div class="row">
                    <c:if test="${sessionScope.LIST_HOTEL.size() != 0}">
                        <c:forEach var="hotel" items="${sessionScope.LIST_HOTEL}">
                            <div class="col-md-4">
