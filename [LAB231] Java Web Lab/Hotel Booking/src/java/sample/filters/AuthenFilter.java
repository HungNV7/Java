...
public class AuthenFilter implements Filter {
    ...
    public AuthenFilter() {
        ...
        member.add("feedback.jsp");
        member.add("history.jsp");
        member.add("nextCart.jsp");
        member.add("searchHistory.jsp");
        member.add("AddServlet");
        member.add("ApplyServlet");
        member.add("CheckoutServlet");
        member.add("ConfirmBookServlet");
        member.add("DeleteServlet");
        member.add("DetailServlet");
        member.add("FeedbackServlet");
        member.add("HistoryServlet");
        member.add("HomeServlet");
        member.add("LogoutServlet");
        member.add("NextCheckoutServlet");
        member.add("RemoveServlet");
        member.add("SearchHistoryServlet");
        member.add("SearchServlet");
        member.add("UpdateServlet");

        others = new ArrayList<String>();
        others.add("detail.jsp");
        others.add("home.jsp");
        others.add("login.jsp");
        others.add("register.jsp");
        others.add("reset.jsp");
        others.add("search.jsp");
        others.add("HomeServlet");
        others.add("SearchServlet");
        others.add("DetailServlet");
        others.add("LoginServlet");
        others.add("RegisterServlet");
        others.add("ResetServlet");
        others.add("SendReqChangePassServlet");
    }
