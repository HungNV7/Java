...
public class ConfirmBookServlet extends HttpServlet {
    ...
    private Logger logger = Logger.getLogger(ConfirmBookServlet.class.getName());
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (orderID.equals(cart.getId()) && userID.equals(user.getUserID())) {
                CartDAO cartDAO = new CartDAO();
                cartDAO.updateStatus(cart.getId(), 5);
